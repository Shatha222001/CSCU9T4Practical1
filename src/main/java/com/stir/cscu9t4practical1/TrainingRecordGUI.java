...
public class TrainingRecordGUI extends JFrame implements ActionListener {
    ...
    private JTextField pool = new JTextField(4);
    ...
    private JLabel labpool = new JLabel(" Pool:");
    ...
    public String addEntryR(String what) {
        ...
        int Repetitions = Integer.parseInt(Reptitions.getText());
        int Recovery = Integer.parseInt(Recovery.getText());
    ...
    public String addEntryS(String what) {
        ...
        int mm = Integer.parseInt(mins.getText());
        int s = Integer.parseInt(secs.getText());
        boolean whr = Boolean.parseBoolean(whr.getText());
